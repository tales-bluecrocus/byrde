...
function initData(): WizardData {
  ...
  const siteName = s.site_name || 'PPC Landing Page';
  return {
    logo: s.logo || '',
    logo_alt: s.logo_alt || '',
    site_name: siteName,
    phone: s.phone || '(123) 456-7890',
    email: s.email || 'email@company.com',
    footer_tagline: s.footer_tagline || 'Your Trusted Local Service Provider',
    footer_description: s.footer_description || 'Professional services you can count on.',
    address: s.address || '123 Main St, City, ST',
    business_hours: s.business_hours || 'Mon-Sat: 7AM - 7PM',
    copyright: s.copyright || `\u00A9 ${year} ${siteName}. All rights reserved.`,
    brand_dark_primary: s.brand_dark_primary || '#3ab342',
    brand_dark_accent: s.brand_dark_accent || '#2d8a33',
    brand_light_primary: s.brand_light_primary || '#3ab342',
    brand_light_accent: s.brand_light_accent || '#2d8a33',
    google_rating: s.google_rating || '5.0',
    google_reviews_count: s.google_reviews_count || '199',
    google_reviews_url: s.google_reviews_url || 'https://g.page/your-business/review',
