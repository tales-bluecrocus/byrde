...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function correct_plugin_mofile( $mofile, $domain ) {
			// [BYRDE PATCH] Guard against null $mofile (PHP 8.1+ deprecation).
			if ( null === $mofile || 'tgmpa' !== $domain ) {
				return $mofile;
			}
		...
		public function admin_menu() {
			...
			// [BYRDE PATCH] Use configured capability instead of hardcoded 'install_plugins'
			// so multisite site admins (who can activate but not install) can still see the page.
